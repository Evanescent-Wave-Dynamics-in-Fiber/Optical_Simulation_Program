...
experimental_file=os.path.join(excel_folder, 'Excel for Minimum Angle of Incidence.xlsx')
...
workbook_file_delaunay2=os.path.join(excel_folder, 'Excel for Workbook File 1_pza_RSM_boundary1_delaunay2.xlsx')
...
for j in range(c):  
    ...
    print('{number}1down'.format(number=i+1))
    ...
    plt.savefig(f'angle-rad-in{j+1}.jpg',format='jpg',dpi=300)
    ...
    plt.savefig(f'angle-NF-rad{j+1}.jpg',format='jpg',dpi=300)
