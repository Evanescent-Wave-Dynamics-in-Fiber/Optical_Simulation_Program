...
experimental_file=os.path.join(excel_folder, 'Excel for Refractive Index of Extental Medium.xlsx')
...
for i in range(number):  
    ...
    plt.savefig(f'ne-rad-in{i+1}.jpg',format='jpg',dpi=300)
    ...
    plt.savefig(f'ne-NF-rad{i+1}.jpg',format='jpg',dpi=300)
