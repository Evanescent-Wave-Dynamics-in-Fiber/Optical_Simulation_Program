...
experimental_file=os.path.join(excel_folder, 'Excel for Wavelength.xlsx')
...
for i in range(number):  
    ...
    plt.savefig(f'lambda-rad-in{i+1}.jpg',format='jpg',dpi=300)
    ...
    plt.savefig(f'lambda-NF-rad{i+1}.jpg',format='jpg',dpi=300)
